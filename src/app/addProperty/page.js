        ...
        <CardContent className="space-y-4">
          <div>
            ...
            {imagePreviews.length > 0 && (
              <div className="mt-4">
                <h4 className="font-medium mb-2">Selected Images ({imagePreviews.length}/5)</h4>
          ...
          {useVideoUpload ? (
            <div>
                 ...
                 <div className="mt-1">
                  ...
                  >
                    {selectedVideoFile ? (
                      ...
                      <span className="text-muted-foreground">Choose video file...</span>
                    )}
                  </label>
                </div>
              </div>
              ...
              {errors.video && <p className="text-sm text-red-500 mt-1">{errors.video.message}</p>}
            </div>
          ) : ( 
                    <div>
                      <Label htmlFor="video-url" >Video URL</Label>
                      <Input id="video-url" placeholder="https://..." {...register('video')} />
